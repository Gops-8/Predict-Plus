...
import './table_performance_based.css'
...
const Table_performance_based = () => {
    ...
    useEffect(() => {
        ...
        fetch('/performance_based').then(function(response){return response.json();}).then(function(data) {
    ...
    return (
        <div>
               <h1>Mutual funds based on performance</h1>
